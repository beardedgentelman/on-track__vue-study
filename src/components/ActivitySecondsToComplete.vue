<script setup>
import { formatSecond, getTotalActivitiesSeconds } from '../helpers/helpers'
...
const secondsDiff = computed(
  () => getTotalActivitiesSeconds(props.activity, timelineItems) - props.activity.secondsToComplete
)
</script>
